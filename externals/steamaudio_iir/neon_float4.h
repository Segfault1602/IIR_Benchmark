...
{
// Returns a + b.
inline float4_t add(float4_t a, float4_t b)
{
    return vaddq_f32(a, b);
}

// Returns a - b.
inline float4_t sub(float4_t a, float4_t b)
{
    return vsubq_f32(a, b);
}

// Returns a * b.
inline float4_t mul(float4_t a, float4_t b)
{
...
// Returns a / b.
inline float4_t div(float4_t a, float4_t b)
{
    return mul(a, rcp(b));
}

// Returns min(a, b).
inline float4_t min(float4_t a, float4_t b)
{
    return vminq_f32(a, b);
}

// Returns max(a, b).
inline float4_t max(float4_t a, float4_t b)
{
...
// Bitwise AND.
inline float4_t andbits(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
}

// Bitwise OR.
inline float4_t orbits(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vorrq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
}

// Bitwise AND-NOT.
inline float4_t andnotbits(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vbicq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
}

// Bitwise XOR.
inline float4_t xorbits(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(veorq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
}

// Returns a mask indicating whether a > b.
inline float4_t cmpgt(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vcgtq_f32(a, b));
}

// Returns a mask indicating whether a < b.
inline float4_t cmplt(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vcltq_f32(a, b));
}

// Returns a mask indicating whether a >= b.
inline float4_t cmpge(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vcgeq_f32(a, b));
}

// Returns a mask indicating whether a <= b.
inline float4_t cmple(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vcleq_f32(a, b));
}

// Returns a mask indicating whether a == b.
inline float4_t cmpeq(float4_t a, float4_t b)
{
    return vreinterpretq_f32_u32(vceqq_f32(a, b));
}

// Returns a mask indicating whether a != b.
inline float4_t cmpneq(float4_t a, float4_t b)
{
...
// Aligned store.
inline void store(float* p, float4_t x)
{
    vst1q_f32(p, x);
}

// Unaligned store.
inline void storeu(float* p, float4_t x)
{
    vst1q_f32(p, x);
}

// Set values of each lane.
inline float4_t set(float w, float x, float y, float z)
{
